...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_X_STEPS_PER_MM 10.0
  #define DEFAULT_Y_STEPS_PER_MM 10.0
  ...
  #define DEFAULT_X_MAX_TRAVEL 38.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 38.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Z_MAX_TRAVEL 38.0 // mm NOTE: Must be a positive value.
